...
!function (t, e, a, i) {
    ...
    s.prototype = {
        init: function () {
            ...
            this.shuffBut.on("click", function () {
            ...
            }), t(this._audio).on("pause", function () {
                ...
                if (nextIndex = e.getIndex() + 1, e.seekTrack.css("width", "0%"), e.listLen != nextIndex)e.source(nextIndex, !0); else {
